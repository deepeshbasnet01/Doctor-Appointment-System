# Generated by Django 4.0.3 on 2022-03-22 13:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialist', models.CharField(blank=True, choices=[('Cardiologist', 'Cardiologist'), ('Dermatologists', 'Dermatologists'), ('Emergency Medicine Specialists', 'Emergency Medicine Specialists'), ('Allergists/Immunologists', 'Allergists/Immunologists'), ('Anesthesiologists', 'Anesthesiologists'), ('Colon and Rectal Surgeons', 'Colon and Rectal Surgeons')], max_length=100, null=True)),
                ('working_hospital', models.CharField(blank=True, max_length=100, null=True)),
